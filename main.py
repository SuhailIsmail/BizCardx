...
if selected == "Home":
    ...
    st.write("## :green[**About :**] :blue[Bizcard is a Python application designed to extract information from business cards.]")
    st.write('## :rainbow[The main purpose of Bizcard is to automate the process of extracting key details from business card images, such as the name, designation, company, contact information, and other relevant data. By leveraging the power of OCR (Optical Character Recognition) provided by EasyOCR, Bizcard is able to extract text from the images.]')
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            uploaded_cards_dir = os.path.join(os.getcwd(), "cards")
